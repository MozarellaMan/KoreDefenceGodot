namespace KoreDefenceGodot.Core.Scripts.Enemy
{
    ...
    {
        public static readonly EnemyType Koreman = new EnemyType("koreman", 400, 130, 5, .5f,"res://Data/Assets/chars/koreman/koremanAnim.tres",
        ...
        public static readonly EnemyType KoreProtector = new EnemyType("koreprotector", 2750, 90, 12, .5f,"res://Data/Assets/chars/koreprotector/koreprotectorAnim.tres",
        ...
        public static readonly EnemyType Korechanic = new EnemyType("korechanic", 1500, 121, 12, .5f,"res://Data/Assets/chars/korechanic/korechanicAnim.tres",
        ...
        public static readonly EnemyType Volcanologist = new EnemyType("volcanologist", 3500, 80, 12, .5f,"res://Data/Assets/chars/volcanologist/volcanAnim.tres",
        ...
        public static readonly EnemyType Machomaniac = new EnemyType("machomaniac", 1200, 85, 12, .5f,"res://Data/Assets/chars/macho/machomanAnim.tres",
        ...
        public static readonly EnemyType Kore = new EnemyType("kore", 50000, 60, 24, .5f,"res://Data/Assets/chars/koreboss/koreAnim.tres", "kore herself");

        private EnemyType(string name, int health, float speed, int damage, float attackRate, string animPath, string description)
        {
            Name = name;
            Health = health;
            Speed = speed;
