namespace KoreDefenceGodot.Core.Scripts.Enemy
{
    ...
    {
        public static readonly EnemyType Koreman = new("koreman", 400, 130, 5, .5f,
        ...
        public static readonly EnemyType KoreProtector = new("koreprotector", 2750, 90, 12, .5f,
        ...
        public static readonly EnemyType Korechanic = new("korechanic", 1500, 121, 12, .5f,
        ...
        public static readonly EnemyType Volcanologist = new("volcanologist", 3500, 80, 12, .5f,
        ...
        public static readonly EnemyType Machomaniac = new("machomaniac", 1200, 85, 12, .5f,
        ...
        public static readonly EnemyType Kore = new("kore", 50000, 60, 24, .5f,
